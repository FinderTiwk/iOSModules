...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_resource "$PODS_CONFIGURATION_BUILD_DIR/XKSCommonSDK/XKSCommonSDK.bundle"
  install_resource "$PODS_CONFIGURATION_BUILD_DIR/XKSHomeModule/XKSHomeModule.bundle"
  install_resource "$PODS_CONFIGURATION_BUILD_DIR/XKSLoginModule/XKSLoginModule.bundle"
  install_resource "$PODS_CONFIGURATION_BUILD_DIR/XKSSettingModule/XKSSettingModule.bundle"
fi
